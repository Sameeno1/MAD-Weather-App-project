...
class ForecastDetailsScreen extends StatefulWidget {
  ...
  final dynamic date;
  final dynamic avgTemp;
  final dynamic minTemp;
  final dynamic maxTemp;
  final dynamic humidity;
  final dynamic maxWind;
  final dynamic visual;
  final dynamic sunRiseTime;
  final dynamic sunSetTime;
  final dynamic moonRiseTime;
  final dynamic moonSetTime;
  final dynamic index;
  final dynamic rainChance;
  final dynamic snowChance;
  final dynamic totalSnow;
  final dynamic uvIndex;
  final dynamic avgVis;
